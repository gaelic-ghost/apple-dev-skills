...
Current baseline checked against the `SpeakSwiftly 3.0.3` package state resolved by this repository on `2026-04-14`. The root package now follows `SpeakSwiftly` with an up-to-next-major semantic-version requirement starting at `3.0.3`.
